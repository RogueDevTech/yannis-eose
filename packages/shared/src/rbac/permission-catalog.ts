...
export const PERMISSIONS: PermissionCatalogEntry[] = [
  ...
  { code: 'orders.inactiveAgents', resource: 'orders', action: 'inactiveAgents', description: 'View inactive CS closers' },
  { code: 'orders.csLeaderboard', resource: 'orders', action: 'csLeaderboard', description: 'View CS leaderboard' },
  {
    code: 'orders.routing',
    resource: 'orders',
    action: 'routing',
    description: 'Configure CS auto-dispatch routing rules (branch + optional product → CS teams)',
  },
  ...
  { code: 'mirror.cs_team', resource: 'mirror', action: 'cs_team', description: 'Mirror CS closers (Head of CS powers)' },
  ...
  { code: 'team.supervise_cs', resource: 'team', action: 'supervise_cs', description: 'Supervise CS closers within branch teams' },
  ...
  { code: 'orders.assign', resource: 'orders', action: 'assign', description: 'Assign or reassign orders to CS closers' },
