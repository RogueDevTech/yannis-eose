...
export function SuperAdminDashboard({ data, userName, filters }: SuperAdminDashboardProps) {
  ...
  // Active Staff + Revenue Generated + ROAS hero removed 2026-05-31 per CEO directive.
            ...
            <OverviewStatStrip
              ...
              items={[
                ...
                },
                {
                  ...
                  value: revenueByPeriod.deliveredThisMonth.toLocaleString(),
                  valueClassName: revenueByPeriod.deliveredThisMonth > 0 ? 'text-success-600 dark:text-success-400' : 'text-app-fg',
                  title: 'Total delivered orders this month',
                  to: '/admin/marketing/orders?status=DELIVERED',
                },
                {
                  label: 'CR',
