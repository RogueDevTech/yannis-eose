...
export async function loader({ request, params }: LoaderFunctionArgs) {
      ...
      if (coRes.ok) {
        ...
        if (coData) {
          ...
          const order: OrderDetail = {
            ...
            isDuplicate: (coData.isDuplicate as string) ?? null,
            duplicateOfId: (coData.duplicateOfId as string) ?? null,
  ...
  return {
    pageData: {
      ...
      isMirroring: !!(user as unknown as Record<string, unknown>).mirroredBy,
