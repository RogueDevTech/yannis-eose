-- Add customer_phone to orders for manual-call reveal when VOIP is off.
-- Edge sends raw phone on create; API stores it and returns only via revealPhoneForManualCall.
