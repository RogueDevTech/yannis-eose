      ...
      <div className="text-center max-w-md">
        ...
        <div className="space-y-3">
          ...
          <a
            ...
            className="block w-full px-4 py-2.5 bg-surface-200 dark:bg-surface-800 text-surface-700 dark:text-surface-300 rounded-lg font-medium hover:bg-surface-300 dark:hover:bg-surface-700 transition-colors text-center"
          >
            Go back
          </a>
        </div>
