      ...
      <div className="fixed inset-x-0 top-[15vh] z-50 mx-auto max-w-lg px-4">
        <div className="rounded-xl bg-white dark:bg-surface-800 shadow-2xl border border-surface-200 dark:border-surface-700 overflow-hidden animate-fade-in">
          ...
          <div className="flex items-center gap-3 px-4 border-b border-surface-100 dark:border-surface-700">
            <svg className="w-5 h-5 text-surface-700 flex-shrink-0 dark:text-surface-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[10px] text-surface-700 bg-surface-100 dark:bg-surface-700 dark:text-surface-400 rounded font-mono">
              ESC
            </kbd>
          </div>
          ...
          {query.length >= 2 && !loading && results.length === 0 && (
            <div className="px-4 py-8 text-center">
              <p className="text-sm text-surface-700 dark:text-surface-500">
          ...
          {/* Footer */}
          <div className="px-4 py-2 border-t border-surface-100 dark:border-surface-700 flex items-center gap-4 text-[11px] text-surface-700 dark:text-surface-500">
