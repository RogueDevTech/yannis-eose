...
INSERT INTO cart_orders (id, source_cart_id, campaign_id, media_buyer_id, status, customer_name, customer_phone_hash, customer_phone, customer_address, delivery_state, total_amount, landed_cost, items, branch_id, servicing_branch_id, order_source, created_at, updated_at)
VALUES
  (gen_random_uuid(), '019e6504-661e-76e4-8905-d57baeff480d', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70ae-55c9-743e-bc11-a0e878c6e7be', 'UNPROCESSED', 'Cart Customer CU-1', encode(sha256('08082100001'::bytea), 'hex'), '08082100001', '1 Cart St, Lagos', 'Lagos', 30000.00, 2500.00, '[{"productId":"019de620-e63a-7607-9cb0-2b32d3561e77","quantity":1,"unitPrice":30000}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(5), _seed_ts(5)),
  (gen_random_uuid(), '019e64a9-9b96-7fd8-b7b8-5e453c9f394d', '019e0d85-e129-77a3-90c6-c740135433d1', '019e70b1-a705-7ba7-8dcd-6251d6106088', 'UNPROCESSED', 'Cart Customer CU-2', encode(sha256('08082100002'::bytea), 'hex'), '08082100002', '2 Cart St, Lagos', 'Lagos', 59500.00, 28000.00, '[{"productId":"019e70ae-55ca-72ac-8cc3-4cbcdbbd742a","quantity":1,"unitPrice":59500}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(6), _seed_ts(6)),
  (gen_random_uuid(), '019e64a6-812c-7c80-ba2b-62f5c52f1b4f', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70b5-897d-7e5d-915b-e3faa20085cc', 'UNPROCESSED', 'Cart Customer CU-3', encode(sha256('08082100003'::bytea), 'hex'), '08082100003', '3 Cart Rd, Abuja', 'FCT', 60000.00, 20000.00, '[{"productId":"019e0cf7-0b5b-7fd0-b6f6-9b1348bb2046","quantity":2,"unitPrice":60000}]'::jsonb, '019df73d-a577-7117-abac-7607fc7017a2', '019df73d-a577-7117-abac-7607fc7017a2', 'offline', _seed_ts(6), _seed_ts(6)),
  (gen_random_uuid(), '019e63ee-8e11-7411-ad47-b820a02e4fed', '019e030b-0576-7d06-9d88-884f5e1387af', '019e70b5-897d-7e5d-915b-e3fd4d80f700', 'UNPROCESSED', 'Cart Customer CU-4', encode(sha256('08082100004'::bytea), 'hex'), '08082100004', '4 Cart Rd, Ibadan', 'Oyo', 30000.00, 18000.00, '[{"productId":"019e16b4-54ab-79fa-bc8c-e209ad9984d7","quantity":1,"unitPrice":30000}]'::jsonb, '019df3db-f659-7330-b2df-a7443b87b63c', '019df3db-f659-7330-b2df-a7443b87b63c', 'offline', _seed_ts(7), _seed_ts(7)),
  (gen_random_uuid(), '019e63ed-4ce9-7564-b2e8-e39fd67e4f92', '019e0d33-5fff-7caf-8f7c-a4d3085726d6', '019e70b1-a705-7ba7-8dcd-624e28b0087c', 'UNPROCESSED', 'Cart Customer CU-5', encode(sha256('08082100005'::bytea), 'hex'), '08082100005', '5 Cart Rd, Ibadan', 'Oyo', 30000.00, 2500.00, '[{"productId":"019de9cd-da69-756b-a0f8-2c9f33706bd6","quantity":1,"unitPrice":30000}]'::jsonb, '019df3db-f659-7330-b2df-a7443b87b63c', '019df3db-f659-7330-b2df-a7443b87b63c', 'offline', _seed_ts(7), _seed_ts(7));

-- 9 CS_ENGAGED cart orders
INSERT INTO cart_orders (id, source_cart_id, campaign_id, media_buyer_id, assigned_cs_id, status, customer_name, customer_phone_hash, customer_phone, customer_address, delivery_state, total_amount, landed_cost, items, branch_id, servicing_branch_id, order_source, created_at, updated_at)
VALUES
  (gen_random_uuid(), '019e63ec-dcae-70ac-8fc7-270678b39889', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70b5-897e-724d-a544-1995c6487542', '019e70ae-55c9-743e-bc11-a0eaa803cedc', 'CS_ENGAGED', 'Cart Engaged CE-1', encode(sha256('08082200001'::bytea), 'hex'), '08082200001', '10 Cart Engaged Rd', 'Lagos', 30000.00, 2500.00, '[{"productId":"019de620-e63a-7607-9cb0-2b32d3561e77","quantity":1,"unitPrice":30000}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(5), _seed_ts(6)),
  (gen_random_uuid(), '019e63aa-ccd0-773c-afde-450b41014343', '019e0d85-e129-77a3-90c6-c740135433d1', '019e70ae-55c9-743e-bc11-a0e878c6e7be', '019e70b1-a705-7ba7-8dcd-6256563a2390', 'CS_ENGAGED', 'Cart Engaged CE-2', encode(sha256('08082200002'::bytea), 'hex'), '08082200002', '11 Cart Engaged Rd', 'Lagos', 59500.00, 28000.00, '[{"productId":"019e70ae-55ca-72ac-8cc3-4cbcdbbd742a","quantity":1,"unitPrice":59500}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(5), _seed_ts(6)),
  (gen_random_uuid(), '019e63a6-eed7-7d77-82c5-22d8dc68158e', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70b1-a705-7ba7-8dcd-6251d6106088', '019e70b1-a705-7ba7-8dcd-6257f99a4507', 'CS_ENGAGED', 'Cart Engaged CE-3', encode(sha256('08082200003'::bytea), 'hex'), '08082200003', '12 Cart Engaged Rd', 'FCT', 60000.00, 20000.00, '[{"productId":"019e0cf7-0b5b-7fd0-b6f6-9b1348bb2046","quantity":2,"unitPrice":60000}]'::jsonb, '019df73d-a577-7117-abac-7607fc7017a2', '019df73d-a577-7117-abac-7607fc7017a2', 'offline', _seed_ts(6), _seed_ts(7)),
  (gen_random_uuid(), '019e63a6-7ef9-7a1d-8436-23f801105eb6', '019e030b-0576-7d06-9d88-884f5e1387af', '019e70b5-897d-7e5d-915b-e3faa20085cc', '019e70b1-a705-7ba7-8dcd-6258a3bbf547', 'CS_ENGAGED', 'Cart Engaged CE-4', encode(sha256('08082200004'::bytea), 'hex'), '08082200004', '13 Cart Engaged Rd', 'Lagos', 30000.00, 18000.00, '[{"productId":"019e16b4-54ab-79fa-bc8c-e209ad9984d7","quantity":1,"unitPrice":30000}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(6), _seed_ts(7)),
  (gen_random_uuid(), '019e63a6-6400-7cc0-bba4-5809f48164a5', '019e0d33-5fff-7caf-8f7c-a4d3085726d6', '019e70b5-897d-7e5d-915b-e3fd4d80f700', '019e70b1-a705-7ba7-8dcd-62598a52e377', 'CS_ENGAGED', 'Cart Engaged CE-5', encode(sha256('08082200005'::bytea), 'hex'), '08082200005', '14 Cart Engaged Rd', 'FCT', 30000.00, 2500.00, '[{"productId":"019de9cd-da69-756b-a0f8-2c9f33706bd6","quantity":1,"unitPrice":30000}]'::jsonb, '019df73d-a577-7117-abac-7607fc7017a2', '019df73d-a577-7117-abac-7607fc7017a2', 'offline', _seed_ts(7), _seed_ts(8)),
  (gen_random_uuid(), '019e63a6-0851-7506-8dcd-58eb82056a1b', '019e0d85-e129-77a3-90c6-c740135433d1', '019e70b1-a705-7ba7-8dcd-624e28b0087c', '019e70b1-a705-7ba7-8dcd-625a1d1abb0e', 'CS_ENGAGED', 'Cart Engaged CE-6', encode(sha256('08082200006'::bytea), 'hex'), '08082200006', '15 Cart Engaged Rd', 'Oyo', 59500.00, 28000.00, '[{"productId":"019e70ae-55ca-72ac-8cc3-4cbcdbbd742a","quantity":1,"unitPrice":59500}]'::jsonb, '019df3db-f659-7330-b2df-a7443b87b63c', '019df3db-f659-7330-b2df-a7443b87b63c', 'offline', _seed_ts(7), _seed_ts(8)),
  (gen_random_uuid(), '019e5eae-8f1c-7c96-b227-504beddbca50', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70b5-897e-724d-a544-1995c6487542', '019e70b1-a705-7ba7-8dcd-625cc10e4003', 'CS_ENGAGED', 'Cart Engaged CE-7', encode(sha256('08082200007'::bytea), 'hex'), '08082200007', '16 Cart Engaged Rd', 'Oyo', 30000.00, 2500.00, '[{"productId":"019de620-e63a-7607-9cb0-2b32d3561e77","quantity":1,"unitPrice":30000}]'::jsonb, '019df3db-f659-7330-b2df-a7443b87b63c', '019df3db-f659-7330-b2df-a7443b87b63c', 'offline', _seed_ts(8), _seed_ts(9)),
  (gen_random_uuid(), '019e5eae-8e44-7b22-bcb9-ffb19d406158', '019e0d44-1c6e-7f76-9452-8680c184119b', '019e70ae-55c9-743e-bc11-a0e878c6e7be', '019e70b5-897e-724d-a544-19982b07bf5f', 'CS_ENGAGED', 'Cart Engaged CE-8', encode(sha256('08082200008'::bytea), 'hex'), '08082200008', '17 Cart Engaged Rd', 'Oyo', 60000.00, 20000.00, '[{"productId":"019e0cf7-0b5b-7fd0-b6f6-9b1348bb2046","quantity":2,"unitPrice":60000}]'::jsonb, '019df3db-f659-7330-b2df-a7443b87b63c', '019df3db-f659-7330-b2df-a7443b87b63c', 'offline', _seed_ts(8), _seed_ts(9)),
  (gen_random_uuid(), '019e5eae-441e-7a45-9d3a-b3b0275e9345', '019e030b-0576-7d06-9d88-884f5e1387af', '019e70b1-a705-7ba7-8dcd-6251d6106088', '019e70ae-55c9-743e-bc11-a0eaa803cedc', 'CS_ENGAGED', 'Cart Engaged CE-9', encode(sha256('08082200009'::bytea), 'hex'), '08082200009', '18 Cart Engaged Rd', 'Lagos', 30000.00, 18000.00, '[{"productId":"019e16b4-54ab-79fa-bc8c-e209ad9984d7","quantity":1,"unitPrice":30000}]'::jsonb, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'offline', _seed_ts(8), _seed_ts(9));
