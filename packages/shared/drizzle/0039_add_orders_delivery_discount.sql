-- Add delivery_discount_amount to orders for 3PL discount at delivery.
-- When marking DELIVERED or PARTIALLY_DELIVERED, 3PL can apply a discount; totalAmount is reduced and this column stores the amount for audit.

-- ── orders ────────────────────────────────────────────────────
ALTER TABLE orders
  ADD COLUMN IF NOT EXISTS delivery_discount_amount numeric(12, 2);
...
BEGIN
  INSERT INTO orders_history (
    ...
    delivery_notes, delivery_proof_url, delivery_discount_amount, parent_order_id,
    ...
    NEW.delivery_notes, NEW.delivery_proof_url, (NEW.delivery_discount_amount)::numeric, NEW.parent_order_id,
