-- Migration: add payment method and Paystack-related columns to orders
-- Columns: payment_method, payment_status, payment_reference, payment_provider, customer_email
