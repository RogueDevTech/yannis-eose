...
-- Sync history table to match (temporal audit trigger copies full rows)
ALTER TABLE cart_orders_history ADD COLUMN IF NOT EXISTS routing_rule_id UUID;
...
-- Backfill: move all cart orders to Lagos for CS (CEO directive)
UPDATE cart_orders
SET servicing_branch_id = '00000000-0000-0000-0000-000000000001',
    updated_at = now()
WHERE servicing_branch_id IS NULL
   OR servicing_branch_id != '00000000-0000-0000-0000-000000000001';
