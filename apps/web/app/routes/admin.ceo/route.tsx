...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const pageData = (async (): Promise<{
    ...
    const data: CEODashboardData = bundle?.overview ?? {
      ...
      marketing: { totalSpend: 0, totalOrders: 0, confirmedOrders: 0, deliveredOrders: 0, cpa: 0, roas: 0, deliveryRate: 0 },
      csTeam: { agentCount: 0, pendingOrders: 0, utilization: 0 },
      payroll: { totalPaid: 0, totalPending: 0, staffCount: 0 },
      invoiceSummary: {},
      revenueByPeriod: { today: 0, thisWeek: 0, thisMonth: 0, deliveredThisMonth: 0 },
      deliveriesByProduct: [],
      stockPerProduct: [],
      activeStaffCount: 0,
    };
