...
const ENDPOINTS: TrpcEndpoint[] = [
  ...
  { procedure: 'orders.assignToCS', method: 'POST', summary: 'Assign order to Sales closer', tag: 'Orders' },
  ...
  { procedure: 'orders.distributeUnassignedOrders', method: 'POST', summary: 'Distribute unassigned (UNPROCESSED) orders to Sales closers', tag: 'Orders' },
  { procedure: 'orders.statusCounts', method: 'GET', summary: 'Get order status counts', tag: 'Orders' },
  { procedure: 'orders.csWorkloads', method: 'GET', summary: 'Sales closer workloads', tag: 'Orders' },
  {
  ...
  { procedure: 'orders.inactiveAgents', method: 'GET', summary: 'List inactive Sales closers', tag: 'Orders' },
  { procedure: 'orders.csLeaderboard', method: 'GET', summary: 'Sales closer leaderboard', tag: 'Orders' },
  ...
  { procedure: 'orders.bulkAssignToCS', method: 'POST', summary: 'Bulk assign orders to Sales', tag: 'Orders' },
