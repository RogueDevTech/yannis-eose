/**
 * Trophy icon for leaderboard ranks 1–3. Gold (1st), silver (2nd), bronze (3rd).
...
/** Trophy/cup icon — outline style with base and handles */
export function LeaderboardTrophy({ rank, className = 'w-5 h-5' }: LeaderboardTrophyProps) {
