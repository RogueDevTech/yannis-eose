  ...
  return (
    <div className="card animate-pulse">
      <div className="flex items-center justify-between">
        ...
        <div className="w-8 h-8 rounded-lg bg-app-hover" />
      </div>
      <div className="h-7 w-24 rounded bg-app-hover mt-3" />
    </div>
  );
}
...
function TableSkeleton() {
  return (
    <div className="card animate-pulse space-y-2">
      <div className="h-4 w-40 rounded bg-app-hover mb-3" />
      {[1, 2, 3].map((i) => (
        <div key={i} className="flex gap-4 py-2">
          <div className="h-3 w-1/4 rounded bg-app-hover" />
          <div className="h-3 w-1/3 rounded bg-app-hover" />
          <div className="h-3 w-1/6 rounded bg-app-hover" />
          <div className="h-3 w-1/6 rounded bg-app-hover" />
        </div>
      ))}
    </div>
...
function ListSkeleton() {
  return (
    <div className="card animate-pulse divide-y divide-app-border">
      <div className="h-4 w-48 rounded bg-app-hover mb-4" />
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="flex items-center gap-3 py-4">
          <div className="h-8 w-8 rounded-full bg-app-hover shrink-0" />
          ...
          <div className="h-6 w-12 rounded bg-app-hover shrink-0" />
        </div>
      ))}
    </div>
  );
...
function InlineSkeleton() {
  return (
    <div className="flex items-center gap-2 py-1">
      <svg className="animate-spin h-4 w-4 text-app-fg-muted" viewBox="0 0 24 24" fill="none">
