...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: (id: string) => void }) {
  ...
  const styles: Record<ToastType, { bg: string; icon: string; title: string; message: string; dismiss: string; iconPath: string }> = {
    success: {
      bg: 'bg-white dark:bg-surface-800 border-success-300 dark:border-success-600',
      ...
      dismiss: 'text-surface-400 hover:text-surface-600 dark:text-surface-400 dark:hover:text-surface-200',
      iconPath: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    },
    error: {
      bg: 'bg-white dark:bg-surface-800 border-danger-300 dark:border-danger-500',
    ...
    warning: {
      bg: 'bg-white dark:bg-surface-800 border-warning-300 dark:border-warning-500',
    ...
    info: {
      bg: 'bg-white dark:bg-surface-800 border-info-300 dark:border-info-500',
