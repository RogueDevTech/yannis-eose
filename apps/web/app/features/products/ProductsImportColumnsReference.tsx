...
const COLUMN_SPECS: ColumnSpec[] = [
  ...
  },
  {
    ...
    required: false,
    description: 'Optional public "from" price in Naira. Leave blank to default to 0 — it auto-syncs to the cheapest offer tier. Numeric, ≥ 0, decimals OK.',
  ...
  },
  {
    ...
    required: false,
    description: 'Optional reference cost in Naira. Real COGS is captured per shipment, not here — leave blank if unknown. Numeric, ≥ 0.',
    examples: ['18000', '7250'],
  },
  {
    header: 'category',
