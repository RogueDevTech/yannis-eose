...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  STOCK_MANAGER: ['inventory.read', 'inventory.intake', 'inventory.transfer', 'inventory.adjust', 'inventory.lowStockAlerts', 'inventory.createReconciliation', 'inventory.resolveReconciliation', 'inventory.reconciliations', 'transfers.read', 'returns.read', 'products.read', 'products.create', 'categories.read', 'categories.write'],
