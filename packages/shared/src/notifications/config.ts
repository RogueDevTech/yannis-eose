...
export const NOTIFICATION_TYPE_META: Record<NotificationType, NotificationTypeMeta> = {
  ...
  'order:assigned': {
    ...
    description: 'CS Closer — order assigned to them',
    mandatory: false,
    category: 'orders',
  },
  'order:assigned_bulk': {
    ...
    description: 'CS Closer — orders reassigned to them (Hot Swap)',
    mandatory: false,
    category: 'orders',
  },
  'order:reassigned': {
    ...
    description: 'CS Closer — their orders were reassigned to another agent',
    mandatory: false,
    category: 'orders',
  },
  'order:allocated': {
  ...
  'order:transfer_requested': {
    ...
    description: 'CS Closer — a colleague requested to transfer an order to you',
    mandatory: false,
    category: 'orders',
  },
  'order:transfer_accepted': {
    ...
    description: 'CS Closer — your order transfer request was accepted',
    mandatory: false,
    category: 'orders',
  },
  'order:transfer_rejected': {
    ...
    description: 'CS Closer — your order transfer request was rejected',
    mandatory: false,
    category: 'orders',
  },
  'order:callback_scheduled': {
    ...
    description: 'CS Closer — callback has been scheduled for an order',
    mandatory: false,
    category: 'orders',
  },
  'order:callback_due': {
    ...
    label: 'Callback due',
    description: 'CS Closer — scheduled callback is now due, call the customer',
    mandatory: false,
    category: 'orders',
  },
  'delivery:assigned': {
