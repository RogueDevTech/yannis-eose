...
export const CONFIGURABLE_EMAIL_TYPES = [
  ...
  'mb_fund_transfer:approved',
  'mb_fund_transfer:rejected',
  'mb_fund_transfer:accepted',
...
export const NOTIFICATION_TYPE_META: Record<NotificationType, NotificationTypeMeta> = {
  ...
  'mb_fund_transfer:pending': {
    ...
    label: 'Peer fund transfer pending',
    description: 'HoM / parties — Media Buyer peer transfer awaiting approval',
    mandatory: false,
    category: 'marketing',
  },
  'mb_fund_transfer:approved': {
    type: 'mb_fund_transfer:approved',
    label: 'Peer fund transfer approved',
    description: 'Sender / receiver — HoM approved a peer fund transfer',
    mandatory: false,
    category: 'marketing',
  },
  'mb_fund_transfer:rejected': {
    type: 'mb_fund_transfer:rejected',
    label: 'Peer fund transfer rejected',
    description: 'Sender / receiver — HoM rejected a peer fund transfer',
    mandatory: false,
    category: 'marketing',
  },
  'mb_fund_transfer:accepted': {
    type: 'mb_fund_transfer:accepted',
    label: 'Peer fund transfer accepted',
    description: 'Sender / HoM — recipient accepted a peer fund transfer',
    mandatory: false,
    category: 'marketing',
  },
  'order:new': {
  ...
  'order:assigned': {
    ...
    description: 'Sales Closer — order assigned to them',
    mandatory: false,
    category: 'orders',
  },
  'order:assigned_bulk': {
    ...
    description: 'Sales Closer — orders reassigned to them (Hot Swap)',
    mandatory: false,
    category: 'orders',
  },
  'order:reassigned': {
    ...
    description: 'Sales Closer — their orders were reassigned to another agent',
    mandatory: false,
    category: 'orders',
  },
  'order:allocated': {
  ...
  'order:transfer_requested': {
    ...
    description: 'Sales Closer — a colleague requested to transfer an order to you',
    mandatory: false,
    category: 'orders',
  },
  'order:transfer_accepted': {
    ...
    description: 'Sales Closer — your order transfer request was accepted',
    mandatory: false,
    category: 'orders',
  },
  'order:transfer_rejected': {
    ...
    description: 'Sales Closer — your order transfer request was rejected',
    mandatory: false,
    category: 'orders',
  },
  'order:callback_scheduled': {
    ...
    description: 'Sales Closer — callback has been scheduled for an order',
    mandatory: false,
    category: 'orders',
  },
  'order:callback_due': {
    ...
    label: 'Callback due',
    description: 'Sales Closer — scheduled callback is now due, call the customer',
    mandatory: false,
    category: 'orders',
  },
  'delivery:assigned': {
  ...
  'account:supervisor_assigned': {
    type: 'account:supervisor_assigned',
    label: 'Promoted to supervisor',
    description: 'User — you were made the supervisor of a branch team',
    mandatory: false,
    category: 'account',
  },
  'account:supervisor_revoked': {
    type: 'account:supervisor_revoked',
    label: 'Supervisor role removed',
    description: 'User — your supervisor status on a branch team was removed',
    mandatory: false,
    category: 'account',
  },
  'approval:permission_request': {
